...
public class UITester03 {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		System.out.println(Thread.currentThread().getName()+" thread went to blocked state...");
		
		System.out.println(result1.get());
		System.out.println(result2.get());
		
		long active = System.currentTimeMillis();
		System.out.println(Thread.currentThread().getName()+" thread will now continue after addStore & addProduct Opeartion "
				+ "finished"+" and it was in blocked state for "+(active-blocked)+" millisec");
	}
}
